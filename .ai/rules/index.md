...
| --- | --- |
| {routes/admin.php,app/Http/Controllers/Admin/**,resources/js/pages/dashboard.tsx,resources/js/pages/admin/analytics.tsx,resources/js/pages/admin/deliveries.tsx} | .ai/rules/admin.md |
...
| {app/Mail/**,app/Jobs/SendResumeEmail.php,app/Actions/*ResumeDelivery*.php,app/Actions/SendResumeEmailAction.php,app/Services/Mailgun/**,app/Http/Controllers/MailgunWebhookController.php,app/Models/{ResumeDelivery,EmailEvent}.php,app/Enums/DeliveryStatus.php,resources/js/components/deliveries/**,resources/views/mail/**,config/mail.php} | .ai/rules/mail.md |
