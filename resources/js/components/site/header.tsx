    ...
    return (
      ...
      */}
            ...
            as part of a bar rather than floating over the avatar. */}
                ...
                <div
                    className="hero-in relative mb-5 inline-flex"
                    style={delay(60)}
                >
                    <div className="from-primary/40 rounded-full bg-linear-to-b to-transparent p-px">
                        {/* The LCP element. Eager and high priority on purpose - never
                lazy, which would push the largest paint a round trip later. */}
                        <img
        ...
        */}
                <div
                    className="hero-in relative isolate mb-3 inline-block"
                    style={delay(170)}
                >
                    <span
                        aria-hidden="true"
                ...
                <p
                    className="text-muted-foreground hero-in mx-auto mb-7 max-w-md text-[15px] text-balance"
                    style={delay(230)}
                >
            ...
            the work. */}
                <dl className="divide-border border-border grid grid-cols-3 divide-x border-t pt-6 pb-2">
                    {stats.map((stat, index) => (
                        ...
                        <div
                            key={stat.label}
                            className="hero-in flex flex-col px-2"
                            style={delay(350 + index * 60)}
                        >
                            <dt className="text-muted-foreground order-2 text-[12px] tracking-wide uppercase">
                                {stat.label}
                            </dt>
